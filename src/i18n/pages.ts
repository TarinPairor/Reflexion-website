...
const pages = {
  en: {
    ...
    how: {
      ...
      heroNote: "The morning has structure. The relationship does not feel like a test.",
      ...
      voiceGate: "Voice reply is a current product requirement; public usability remains subject to implementation and QA.",
      ...
      caregiverQuestions: [
        ...
        ["How can I stay part of their day?", "Send text, voice and photos, and receive a loved-one voice reply when available and QA-verified."],
    ...
    products: {
      ...
      selectTitle: "Which would feel most natural in your loved one’s home?",
      selectBody: "Choose one form to carry into Get Reflexion. No payment will be taken today.",
      ...
      proofBody: "Verified form-preference quotations are not included in the active evidence package, so this page does not invent a testimonial.",
    },
    about: {
      heroTitle: "Reflexion started with our own family.",
      heroBody: "Kei-Lyn’s grandmother, known in the family as Mama, had dementia. Her experience shaped a personal question: how might families stay meaningfully present while respecting the life and dignity of the person they love?",
      heroLimit: "Mama’s story explains why Reflexion exists. It does not imply that Reflexion could have diagnosed, detected, prevented or treated her dementia.",
    ...
    faq: {
      heroTitle: "Questions deserve clear, human answers.",
  ...
  zh: {
    ...
    how: {
      heroTitle: "围绕关系展开的一天。", heroBody: "Reflexion 从挚爱家人开始——他们的早晨、声音与日常——再为家人提供足够背景，知道什么时候亲自联系更重要。", heroNote: "早晨有一点结构，关系却不应像测试。",
      ...
      familyTitle: "一条信息，成为一段对话。", familyBody: "家庭联系双向流动，让了解重新回到关系。", familyFlow: [["照护者发送", "从照护者 App 发送文字、语音或照片。"], ["挚爱家人收到", "家庭信息通过 Reflexion 抵达。"], ["挚爱家人回复", "用自己的声音录制回复。"], ["照护者收到", "语音回复回到家庭聊天。"]], voiceGate: "语音回复是当前产品要求；公开可用性仍须通过实现与 QA。",
