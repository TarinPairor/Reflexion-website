...
const pages = {
  ...
  zh: {
    ...
    products: {
      ...
      selectTitle: "哪一种最自然地融入挚爱家人的家？", selectBody: "选择一种形态加入试点。最终试点形态可能取决于可用性与适配情况。", caregiverTitle: "照护者 App 连接整个系统。", caregiverBody: "照护者体验帮助你了解今天、留意有意义的变化、保持联系，并决定下一步如何亲自关心。", supportTitle: "为人选择，而不是为规格表选择。", supportBody: "考虑他们早上自然停留的位置、是否已习惯手机、固定位置是否更容易，以及怎样的存在感在家中更尊重。", proofLabel: "选择支持", proofBody: "当前证据包未包含已核实的形态偏好引述，因此本页不会虚构见证。",
    },
    about: {
