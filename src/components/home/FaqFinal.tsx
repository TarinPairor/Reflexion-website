...
export function FaqFinal({ content }: { content: Content }) {
  return <section className="faq-final" id="faq" aria-labelledby="faq-title">
    <div className="faq-preview">
      <div className="faq-preview__heading"><p className="eyebrow">{content.faq.eyebrow}</p><h2 id="faq-title">{content.faq.title}</h2></div>
      <div className="faq-preview__items">
    ...
    <div className="final-cta" id="get-reflexion">
