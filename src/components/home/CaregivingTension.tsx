...
export function CaregivingTension({ content }: { content: Content }) {
  ...
  return <section className="tension" aria-labelledby="tension-title">
    <div className="tension__hero">
    ...
    <figure className="tension__quote">
      <span aria-hidden="true">“</span>
      <div><figcaption>{content.tension.quoteLabel}</figcaption><blockquote>“{content.tension.quote}”</blockquote></div>
    </figure>
    <div className="tension__why">
      <p>{content.tension.question}</p>
      <p>{content.tension.body}</p>
    </div>
    <p className="tension__closing">{content.tension.closing}<span aria-hidden="true">⌄</span></p>
  </section>;
}
