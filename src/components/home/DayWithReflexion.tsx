...
export function DayWithReflexion({ content }: { content: Content }) {
  return <section className="day" id="day-with-reflexion" aria-labelledby="day-title">
    ...
    <p className="product-note">{content.day.note}</p>
  </section>;
}
