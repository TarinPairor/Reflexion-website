...
export function PilotThankYou() {
  ...
  const whatsappLink = useMemo(() => {
    const message = `Hi! I came across Reflexion, a new project exploring whether everyday conversations could help families better understand changes in memory, speech and thinking over time.
